      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto  lg:px-24">
        ...
        <div className={`${isOpen ? 'hidden' : ''} w-full md:block md:w-auto mx-2`} id="navbar-default">
          <ul className="flex flex-col p-4 mt-4  rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 ">
            <li>  
              <Link to="about" className="block py-2 pr-4 pl-3 text-gray-700 rounded md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-gray-700 md:dark:hover:bg-transparent text-lg font-semibold">About</Link>
            </li>
           
            <li>
              <Link to="/projectlist" className="block py-2 pr-4 pl-3 text-gray-700 rounded md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-gray-700 md:dark:hover:bg-transparent text-lg font-semibold">Projects</Link>
            </li>
            <li>
              <Link to="/contact" className="block py-2 pr-4 pl-3 text-gray-700 rounded md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent text-lg font-semibold">Contact</Link>
            </li>
          </ul>
        </div>
      </div>
